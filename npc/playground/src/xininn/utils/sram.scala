...
class AXI4 extends Bundle {
  val ar = Flipped(Decoupled(new arport))
  val r  = Decoupled(new rport)
  val aw = Flipped(Decoupled(new awport))
  val w  = Flipped(Decoupled(new wport))
  val b = Decoupled(new bport)
}
