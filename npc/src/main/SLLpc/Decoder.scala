...
class I extends Module with DecoderTemplate {
  ...
  val table = TruthTable(
    Map(
      BitPat("b0000000 ????? ????? 000 ????? 00100 11") -> BitPat("b0000"), // ADDI: ALU_ADD
      BitPat("b??????? ????? ????? 100 ????? 00100 11") -> BitPat("b0100"), // XORI: ALU_XOR
      BitPat("b??????? ????? ????? 111 ????? 00100 11") -> BitPat("b0010"), // ANDI: ALU_AND
      BitPat("b??????? ????? ????? 001 ????? 00100 11") -> BitPat("b0101"), // SLLI: ALU_SLL
      BitPat("b0000000 ????? ????? 101 ????? 00100 11") -> BitPat("b0110"), // SRLI: ALU_SRL
      BitPat("b0100000 ????? ????? 101 ????? 00100 11") -> BitPat("b0111"), // SRAI: ALU_SRA
      BitPat("b??????? ????? ????? 000 ????? 00000 11") -> BitPat("b1000"), // LB: ALU_LB
      BitPat("b??????? ????? ????? 001 ????? 00000 11") -> BitPat("b1001"), // LH: ALU_LH
      BitPat("b??????? ????? ????? 010 ????? 00000 11") -> BitPat("b1010"), // LW: ALU_LW
      BitPat("b??????? ????? ????? 100 ????? 00000 11") -> BitPat("b1011"), // LBU: ALU_LBU
      BitPat("b??????? ????? ????? 101 ????? 00000 11") -> BitPat("b1100")  // LHU: ALU_LHU
    ),
    BitPat("b0000".U) // 默认情况
  )
}
