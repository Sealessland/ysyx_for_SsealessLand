...
void Vcore___024root__trace_chg_0_sub_0(Vcore___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
                                      ...
                                      | ((IData)(vlSelfRef.core__DOT__executer__DOT____VdfgRegularize_h3006ad77_0_14) 
                                         | ((0x17U 
                                            ...
                                            | (0x18U 
                                               == (IData)(vlSelfRef.__VdfgRegularize_hd87f99a1_0_2))))))) 
                               & (IData)(vlSelfRef.core__DOT__executer__DOT____VdfgRegularize_h3006ad77_0_11))));
        bufp->chgBit(oldp+27,(((~ ((((IData)(vlSelfRef.core__DOT__executer__DOT___GEN_28) 
                                     | ((0x14U == (IData)(vlSelfRef.__VdfgRegularize_hd87f99a1_0_2)) 
                                        | ((IData)(vlSelfRef.core__DOT__executer__DOT____VdfgRegularize_h3006ad77_0_14) 
                                           | ((0x17U 
                                               == (IData)(vlSelfRef.__VdfgRegularize_hd87f99a1_0_2)) 
        ...
        bufp->chgQData(oldp+28,((QData)((IData)(vlSelfRef.core__DOT__instfetch__DOT__pc))),64);
        bufp->chgQData(oldp+30,((QData)((IData)(vlSelfRef.core__DOT__ram2r1w__DOT__mem__DOT__mem_rdata))),64);
        bufp->chgBit(oldp+32,(vlSelfRef.core__DOT__instfetch__DOT__pc_en));
        bufp->chgIData(oldp+33,(vlSelfRef.core__DOT__instfetch__DOT__pc),32);
        bufp->chgIData(oldp+34,(vlSelfRef.core__DOT__ram2r1w__DOT__mem__DOT__mem_rdata),32);
        bufp->chgIData(oldp+35,((vlSelfRef.core__DOT__instfetch__DOT__pc 
                                 - (IData)(0x80000000U))),32);
        bufp->chgIData(oldp+36,(vlSelfRef.core__DOT__ram2r1w__DOT__mem__DOT__addr_offset_dmem),32);
        bufp->chgIData(oldp+37,(vlSelfRef.core__DOT__ram2r1w__DOT__mem__DOT__lower_data),32);
        bufp->chgIData(oldp+38,(vlSelfRef.core__DOT__ram2r1w__DOT__mem__DOT__upper_data),32);
        bufp->chgQData(oldp+39,((QData)((IData)(vlSelfRef.core__DOT____Vcellinp__control__io_rf_data))),64);
        bufp->chgQData(oldp+41,((QData)((IData)(((0U 
                                                  != (IData)(vlSelfRef.core__DOT___decode_io_rs2_addr))
                                                  ? vlSelfRef.core__DOT__rf__DOT__casez_tmp_0
                                                  : 0U)))),64);
        bufp->chgQData(oldp+43,((QData)((IData)(vlSelfRef.core__DOT___executer_io_out))),64);
        bufp->chgIData(oldp+45,(vlSelfRef.core__DOT__rf__DOT__rf_0),32);
        bufp->chgIData(oldp+46,(vlSelfRef.core__DOT__rf__DOT__rf_1),32);
        bufp->chgIData(oldp+47,(vlSelfRef.core__DOT__rf__DOT__rf_2),32);
        bufp->chgIData(oldp+48,(vlSelfRef.core__DOT__rf__DOT__rf_3),32);
        bufp->chgIData(oldp+49,(vlSelfRef.core__DOT__rf__DOT__rf_4),32);
        bufp->chgIData(oldp+50,(vlSelfRef.core__DOT__rf__DOT__rf_5),32);
        bufp->chgIData(oldp+51,(vlSelfRef.core__DOT__rf__DOT__rf_6),32);
        bufp->chgIData(oldp+52,(vlSelfRef.core__DOT__rf__DOT__rf_7),32);
        bufp->chgIData(oldp+53,(vlSelfRef.core__DOT__rf__DOT__rf_8),32);
        bufp->chgIData(oldp+54,(vlSelfRef.core__DOT__rf__DOT__rf_9),32);
        bufp->chgIData(oldp+55,(vlSelfRef.core__DOT__rf__DOT__rf_10),32);
        bufp->chgIData(oldp+56,(vlSelfRef.core__DOT__rf__DOT__rf_11),32);
        bufp->chgIData(oldp+57,(vlSelfRef.core__DOT__rf__DOT__rf_12),32);
        bufp->chgIData(oldp+58,(vlSelfRef.core__DOT__rf__DOT__rf_13),32);
        bufp->chgIData(oldp+59,(vlSelfRef.core__DOT__rf__DOT__rf_14),32);
        bufp->chgIData(oldp+60,(vlSelfRef.core__DOT__rf__DOT__rf_15),32);
        bufp->chgIData(oldp+61,(vlSelfRef.core__DOT__rf__DOT__rf_16),32);
        bufp->chgIData(oldp+62,(vlSelfRef.core__DOT__rf__DOT__rf_17),32);
        bufp->chgIData(oldp+63,(vlSelfRef.core__DOT__rf__DOT__rf_18),32);
        bufp->chgIData(oldp+64,(vlSelfRef.core__DOT__rf__DOT__rf_19),32);
        bufp->chgIData(oldp+65,(vlSelfRef.core__DOT__rf__DOT__rf_20),32);
        bufp->chgIData(oldp+66,(vlSelfRef.core__DOT__rf__DOT__rf_21),32);
        bufp->chgIData(oldp+67,(vlSelfRef.core__DOT__rf__DOT__rf_22),32);
        bufp->chgIData(oldp+68,(vlSelfRef.core__DOT__rf__DOT__rf_23),32);
        bufp->chgIData(oldp+69,(vlSelfRef.core__DOT__rf__DOT__rf_24),32);
        bufp->chgIData(oldp+70,(vlSelfRef.core__DOT__rf__DOT__rf_25),32);
        bufp->chgIData(oldp+71,(vlSelfRef.core__DOT__rf__DOT__rf_26),32);
        bufp->chgIData(oldp+72,(vlSelfRef.core__DOT__rf__DOT__rf_27),32);
        bufp->chgIData(oldp+73,(vlSelfRef.core__DOT__rf__DOT__rf_28),32);
        bufp->chgIData(oldp+74,(vlSelfRef.core__DOT__rf__DOT__rf_29),32);
        bufp->chgIData(oldp+75,(vlSelfRef.core__DOT__rf__DOT__rf_30),32);
        bufp->chgIData(oldp+76,(vlSelfRef.core__DOT__rf__DOT__rf_31),32);
        bufp->chgIData(oldp+77,(vlSelfRef.core__DOT__rf__DOT__casez_tmp),32);
        bufp->chgIData(oldp+78,(vlSelfRef.core__DOT__rf__DOT__casez_tmp_0),32);
    }
    bufp->chgBit(oldp+79,(vlSelfRef.clock));
    bufp->chgBit(oldp+80,(vlSelfRef.reset));
    bufp->chgIData(oldp+81,(vlSelfRef.io_debugPC),32);
    bufp->chgIData(oldp+82,(vlSelfRef.io_debugInst),32);
    bufp->chgIData(oldp+83,(vlSelfRef.io_debugDNPC),32);
}
