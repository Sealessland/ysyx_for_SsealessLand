...
VL_INLINE_OPT void Vcore___024root___nba_sequent__TOP__0(Vcore___024root* vlSelf) {
    ...
    // Body
    if ((1U == (IData)(vlSelfRef.core__DOT___idu_io_out_bits_system))) {
    ...
    if (((~ (IData)(vlSelfRef.core__DOT__ifu__DOT__state)) 
    ...
    vlSelfRef.core__DOT__wbu__DOT__io_w2f_inst_done_REG 
        = ((~ (IData)(vlSelfRef.reset)) & ((((0U == (IData)(vlSelfRef.core__DOT__lsu__DOT__state))
    ...
    if (vlSelfRef.reset) {
        ...
        vlSelfRef.core__DOT__ifu__DOT__dnpc_delay = 0U;
        ...
        vlSelfRef.core__DOT__ls_sram__DOT__b_valid_reg 
            = __Vdly__core__DOT__ls_sram__DOT__b_valid_reg;
        vlSelfRef.core__DOT__ifu__DOT__dnpc_delay = vlSelfRef.core__DOT___exu_io_pcCtrl_dnpc;
        ...
        if (vlSelfRef.core__DOT__ls_sram__DOT__r_state) {
        ...
        vlSelfRef.core__DOT__ls_sram__DOT__r_valid_reg 
            = __Vdly__core__DOT__ls_sram__DOT__r_valid_reg;
        if (vlSelfRef.core__DOT__ifu__DOT___GEN_0) {
            if (((IData)(vlSelfRef.core__DOT__ifu__DOT__state) 
                 & (IData)(vlSelfRef.core__DOT__ifu__DOT___GEN))) {
                __Vdly__core__DOT__ifu__DOT__pc = ((IData)(4U) 
                                                   + vlSelfRef.core__DOT__ifu__DOT__pc);
            }
            __Vdly__core__DOT__ifu__DOT__state = ((IData)(vlSelfRef.core__DOT__ifu__DOT__state)
                                                   ? 
                                                  ((~ (IData)(vlSelfRef.core__DOT__ifu__DOT___GEN)) 
    ...
    if (vlSelfRef.core__DOT__lsu__DOT___GEN_6) {
    ...
    if (vlSelfRef.reset) {
        ...
        if (vlSelfRef.core__DOT__lsu__DOT__io_in_ready_0) {
            if ((1U & (~ ((IData)(vlSelfRef.core__DOT__lsu__DOT__isPassthrough) 
                ...
                if ((1U == (IData)(vlSelfRef.core__DOT___exu_io_out_bits_mem_wr))) {
                    vlSelfRef.core__DOT__lsu__DOT__state = 1U;
                } else if ((2U == (IData)(vlSelfRef.core__DOT___exu_io_out_bits_mem_wr))) {
            ...
            if (vlSelfRef.core__DOT__lsu__DOT___GEN_1) {
                vlSelfRef.core__DOT__lsu__DOT__state = 0U;
            }
        ...
        } else if (vlSelfRef.core__DOT__lsu__DOT___GEN_10) {
            vlSelfRef.core__DOT__lsu__DOT__state = 0U;
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 2256, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 2256, "", "Active region did not converge.");
            }
