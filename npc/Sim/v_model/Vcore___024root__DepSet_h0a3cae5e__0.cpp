...
extern "C" void mem_read(int addr, int len, int* data);

VL_INLINE_OPT void Vcore___024root____Vdpiimwrap_core__DOT__ram2r1w__DOT__mem__DOT__mem_read_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ &data) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcore___024root____Vdpiimwrap_core__DOT__ram2r1w__DOT__mem__DOT__mem_read_TOP\n"); );
    // Body
    int addr__Vcvt;
    ...
    int data__Vcvt;
    mem_read(addr__Vcvt, len__Vcvt, &data__Vcvt);
    data = data__Vcvt;
}

extern "C" void mem_write(int addr, int len, int data);

VL_INLINE_OPT void Vcore___024root____Vdpiimwrap_core__DOT__ram2r1w__DOT__mem__DOT__mem_write_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ data) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcore___024root____Vdpiimwrap_core__DOT__ram2r1w__DOT__mem__DOT__mem_write_TOP\n"); );
    // Body
    int addr__Vcvt;
    for (size_t addr__Vidx = 0; addr__Vidx < 1; ++addr__Vidx) addr__Vcvt = addr;
    int len__Vcvt;
