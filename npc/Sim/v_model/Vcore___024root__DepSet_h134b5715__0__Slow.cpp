...
#endif
            VL_FATAL_MT("build/core.sv", 2568, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vcore___024root___ctor_var_reset(Vcore___024root* vlSelf) {
    ...
    vlSelf->core__DOT__exu__DOT___GEN_3 = VL_RAND_RESET_I(1);
    ...
    vlSelf->core__DOT__exu__DOT____VdfgRegularize_h1784965b_0_0 = VL_RAND_RESET_I(1);
    ...
    vlSelf->core__DOT__lsu__DOT___GEN_13 = VL_RAND_RESET_I(1);
    ...
    vlSelf->core__DOT__if_sram__DOT___read_backend_io_en_T = VL_RAND_RESET_I(1);
    ...
    vlSelf->__VdfgRegularize_hd87f99a1_5_0 = VL_RAND_RESET_I(32);
